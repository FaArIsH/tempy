...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/constraint/solver/widgets/k$a;
    }
.end annotation
...
.method public constructor <init>(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/k;->e:Ljava/util/ArrayList;
    ...
    .line 99
    iget-object v3, p0, Landroid/support/constraint/solver/widgets/k;->e:Ljava/util/ArrayList;

    new-instance v4, Landroid/support/constraint/solver/widgets/k$a;

    invoke-direct {v4, v2}, Landroid/support/constraint/solver/widgets/k$a;-><init>(Landroid/support/constraint/solver/widgets/ConstraintAnchor;)V
...
.method public a(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 113
    iget-object v0, p0, Landroid/support/constraint/solver/widgets/k;->e:Ljava/util/ArrayList;
    ...
    .line 115
    iget-object v2, p0, Landroid/support/constraint/solver/widgets/k;->e:Ljava/util/ArrayList;

    invoke-virtual {v2, v1}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/support/constraint/solver/widgets/k$a;

    .line 116
    invoke-virtual {v2, p1}, Landroid/support/constraint/solver/widgets/k$a;->a(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
...
.method public b(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 128
    iget v0, p0, Landroid/support/constraint/solver/widgets/k;->c:I

    invoke-virtual {p1, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->h(I)V

    .line 129
    iget v0, p0, Landroid/support/constraint/solver/widgets/k;->d:I
    ...
    .line 132
    invoke-virtual {v2, p1}, Landroid/support/constraint/solver/widgets/k$a;->b(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
