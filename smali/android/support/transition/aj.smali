...
.method static d(Landroid/view/View;)Landroid/support/transition/aj;
    ...
    .line 71
    instance-of v4, v3, Landroid/support/transition/aj$a;

    if-eqz v4, :cond_0

    .line 72
    check-cast v3, Landroid/support/transition/aj$a;

    iget-object p0, v3, Landroid/support/transition/aj$a;->e:Landroid/support/transition/aj;
    ...
    .line 75
    :cond_1
    new-instance v1, Landroid/support/transition/ac;

    invoke-virtual {v0}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2, v0, p0}, Landroid/support/transition/ac;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/View;)V
