.class Landroid/support/d/a/i$e;
...
.method private a(Landroid/graphics/Matrix;)F
    ...
    invoke-static {p1, v3, v2, v0}, Landroid/support/d/a/i$e;->a(FFFF)F
...
.method private a(Landroid/support/d/a/i$c;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    .line 1132
    invoke-static {p1}, Landroid/support/d/a/i$c;->a(Landroid/support/d/a/i$c;)Landroid/graphics/Matrix;
    ...
    invoke-static {p1}, Landroid/support/d/a/i$c;->b(Landroid/support/d/a/i$c;)Landroid/graphics/Matrix;
    ...
    .line 1140
    :goto_0
    iget-object v0, p1, Landroid/support/d/a/i$c;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v2 .. v8}, Landroid/support/d/a/i$e;->a(Landroid/support/d/a/i$c;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    check-cast v4, Landroid/support/d/a/i$d;
    ...
    .line 1148
    invoke-direct/range {v2 .. v8}, Landroid/support/d/a/i$e;->a(Landroid/support/d/a/i$c;Landroid/support/d/a/i$d;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method private a(Landroid/support/d/a/i$c;Landroid/support/d/a/i$d;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    .locals 7

    int-to-float p4, p4

    .line 1162
    iget v0, p0, Landroid/support/d/a/i$e;->d:F
    ...
    .line 1163
    iget v0, p0, Landroid/support/d/a/i$e;->e:F
    ...
    .line 1167
    iget-object v1, p0, Landroid/support/d/a/i$e;->l:Landroid/graphics/Matrix;
    ...
    .line 1171
    invoke-direct {p0, p1}, Landroid/support/d/a/i$e;->a(Landroid/graphics/Matrix;)F
    ...
    .line 1176
    :cond_0
    iget-object p5, p0, Landroid/support/d/a/i$e;->i:Landroid/graphics/Path;

    invoke-virtual {p2, p5}, Landroid/support/d/a/i$d;->a(Landroid/graphics/Path;)V

    .line 1177
    iget-object p5, p0, Landroid/support/d/a/i$e;->i:Landroid/graphics/Path;

    .line 1179
    iget-object v1, p0, Landroid/support/d/a/i$e;->j:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    .line 1181
    invoke-virtual {p2}, Landroid/support/d/a/i$d;->a()Z
    ...
    .line 1182
    iget-object p1, p0, Landroid/support/d/a/i$e;->j:Landroid/graphics/Path;

    iget-object p2, p0, Landroid/support/d/a/i$e;->l:Landroid/graphics/Matrix;
    ...
    .line 1190
    iget-object v2, p0, Landroid/support/d/a/i$e;->o:Landroid/graphics/PathMeasure;
    ...
    iput-object v2, p0, Landroid/support/d/a/i$e;->o:Landroid/graphics/PathMeasure;

    .line 1193
    :cond_3
    iget-object v2, p0, Landroid/support/d/a/i$e;->o:Landroid/graphics/PathMeasure;

    iget-object v5, p0, Landroid/support/d/a/i$e;->i:Landroid/graphics/Path;
    ...
    .line 1200
    iget-object v5, p0, Landroid/support/d/a/i$e;->o:Landroid/graphics/PathMeasure;

    invoke-virtual {v5, v1, v2, p5, v3}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    .line 1201
    iget-object v1, p0, Landroid/support/d/a/i$e;->o:Landroid/graphics/PathMeasure;
    ...
    .line 1207
    :cond_5
    iget-object p4, p0, Landroid/support/d/a/i$e;->j:Landroid/graphics/Path;
    ...
    .line 1209
    iget p4, p2, Landroid/support/d/a/i$b;->c:I

    if-eqz p4, :cond_8

    .line 1210
    iget-object p4, p0, Landroid/support/d/a/i$e;->n:Landroid/graphics/Paint;
    ...
    iput-object p4, p0, Landroid/support/d/a/i$e;->n:Landroid/graphics/Paint;
    ...
    .line 1217
    iget p5, p2, Landroid/support/d/a/i$b;->c:I

    iget v1, p2, Landroid/support/d/a/i$b;->f:F

    invoke-static {p5, v1}, Landroid/support/d/a/i;->a(IF)I
    ...
    .line 1219
    iget-object p5, p0, Landroid/support/d/a/i$e;->j:Landroid/graphics/Path;

    iget v1, p2, Landroid/support/d/a/i$b;->e:I
    ...
    .line 1224
    :cond_8
    iget p4, p2, Landroid/support/d/a/i$b;->a:I

    if-eqz p4, :cond_c

    .line 1225
    iget-object p4, p0, Landroid/support/d/a/i$e;->m:Landroid/graphics/Paint;
    ...
    iput-object p4, p0, Landroid/support/d/a/i$e;->m:Landroid/graphics/Paint;
    ...
    .line 1232
    iget-object p5, p2, Landroid/support/d/a/i$b;->k:Landroid/graphics/Paint$Join;
    ...
    .line 1236
    :cond_a
    iget-object p5, p2, Landroid/support/d/a/i$b;->j:Landroid/graphics/Paint$Cap;
    ...
    .line 1240
    :cond_b
    iget p5, p2, Landroid/support/d/a/i$b;->l:F

    invoke-virtual {p4, p5}, Landroid/graphics/Paint;->setStrokeMiter(F)V

    .line 1241
    iget p5, p2, Landroid/support/d/a/i$b;->a:I

    iget v1, p2, Landroid/support/d/a/i$b;->d:F
