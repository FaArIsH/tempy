...
.method public a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
    ...
    .line 971
    invoke-virtual {p0}, Landroid/support/d/a/i$f;->a()Z
    ...
    .line 975
    :cond_0
    iget-object v0, p0, Landroid/support/d/a/i$f;->l:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/d/a/i$f;->l:Landroid/graphics/Paint;
    ...
    invoke-virtual {v1}, Landroid/support/d/a/i$e;->getRootAlpha()I
    ...
    .line 981
    iget-object p1, p0, Landroid/support/d/a/i$f;->l:Landroid/graphics/Paint;
...
.method public a(II)V
    ...
    invoke-virtual {v1, v0, p1, p2, v2}, Landroid/support/d/a/i$e;->a(Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method public a(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
    ...
    .line 959
    invoke-virtual {p0, p2}, Landroid/support/d/a/i$f;->a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
...
.method public b(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/d/a/i$f;->c(II)Z
    ...
    iput-object p1, p0, Landroid/support/d/a/i$f;->f:Landroid/graphics/Bitmap;

    const/4 p1, 0x1

    .line 994
    iput-boolean p1, p0, Landroid/support/d/a/i$f;->k:Z
...
.method public b()Z
    ...
    .line 1008
    iget-boolean v0, p0, Landroid/support/d/a/i$f;->k:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/d/a/i$f;->g:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/d/a/i$f;->c:Landroid/content/res/ColorStateList;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Landroid/support/d/a/i$f;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v1, p0, Landroid/support/d/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Landroid/support/d/a/i$f;->j:Z

    iget-boolean v1, p0, Landroid/support/d/a/i$f;->e:Z

    if-ne v0, v1, :cond_0

    iget v0, p0, Landroid/support/d/a/i$f;->i:I
...
.method public c()V
    ...
    .line 1021
    iget-object v0, p0, Landroid/support/d/a/i$f;->c:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Landroid/support/d/a/i$f;->g:Landroid/content/res/ColorStateList;

    .line 1022
    iget-object v0, p0, Landroid/support/d/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v0, p0, Landroid/support/d/a/i$f;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/d/a/i$f;->i:I

    .line 1024
    iget-boolean v0, p0, Landroid/support/d/a/i$f;->e:Z

    iput-boolean v0, p0, Landroid/support/d/a/i$f;->j:Z

    const/4 v0, 0x0

    .line 1025
    iput-boolean v0, p0, Landroid/support/d/a/i$f;->k:Z
...
.method public c(II)Z
    ...
    iget-object p1, p0, Landroid/support/d/a/i$f;->f:Landroid/graphics/Bitmap;
