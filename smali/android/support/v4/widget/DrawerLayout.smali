...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/q;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/q$a;)Landroid/support/v4/widget/q;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    .line 317
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    invoke-virtual {p3, p2}, Landroid/support/v4/widget/q;->a(I)V

    .line 318
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/q;->a(F)V
    ...
    invoke-virtual {p3, v4}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/q;)V
    ...
    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/q;

    .line 322
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/q;

    const/4 v3, 0x2

    invoke-virtual {p3, v3}, Landroid/support/v4/widget/q;->a(I)V
    ...
    invoke-virtual {p3, v2}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/q;)V

    .line 327
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 329
    invoke-static {p0, p2}, Landroid/support/v4/view/s;->a(Landroid/view/View;I)V
    ...
    invoke-static {p0, p2}, Landroid/support/v4/view/s;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
...
.method public a(II)V
    ...
    .line 590
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    goto :goto_1

    :cond_4
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/q;

    .line 591
    :goto_1
    invoke-virtual {p2}, Landroid/support/v4/widget/q;->e()V
...
.method a(IILandroid/view/View;)V
    ...
    .line 755
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    invoke-virtual {p1}, Landroid/support/v4/widget/q;->a()I
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v1, v0}, Landroid/support/v4/widget/q;->a(Landroid/view/View;II)Z
    ...
    .line 1607
    invoke-virtual {p2, p1, v0, v1}, Landroid/support/v4/widget/q;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1557
    invoke-virtual {v7, v4, v6, v8}, Landroid/support/v4/widget/q;->a(Landroid/view/View;II)Z
    ...
    .line 1560
    invoke-virtual {v6, v4, v7, v8}, Landroid/support/v4/widget/q;->a(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/q;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1380
    iget-object v8, v0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    invoke-virtual {v8}, Landroid/support/v4/widget/q;->b()I
    ...
    .line 1392
    iget-object v10, v0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/q;

    invoke-virtual {v10}, Landroid/support/v4/widget/q;->b()I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1428
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/q;

    invoke-virtual {v1, p1}, Landroid/support/v4/widget/q;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1429
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/q;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/q;->d(I)Z
    ...
    invoke-virtual {v4, v0, p1}, Landroid/support/v4/widget/q;->d(II)Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    .line 1019
    invoke-static {v12}, Landroid/support/v4/view/s;->q(Landroid/view/View;)Z
    ...
    .line 1062
    invoke-static {v12}, Landroid/support/v4/view/s;->m(Landroid/view/View;)F
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1925
    iget p1, p1, Landroid/support/v4/widget/DrawerLayout$e;->f:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/widget/q;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/q;->d()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/s;->a(Landroid/view/View;F)V
