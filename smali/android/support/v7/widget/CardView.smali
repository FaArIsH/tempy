...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-interface/range {v1 .. v7}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/af;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
...
.method protected onMeasure(II)V
    ...
    .line 235
    :cond_0
    sget-object v3, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/ag;

    iget-object v4, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/af;

    invoke-interface {v3, v4}, Landroid/support/v7/widget/ag;->b(Landroid/support/v7/widget/af;)F
...
.method public setPreventCornerOverlap(Z)V
    ...
    .line 437
    sget-object p1, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/ag;

    iget-object v0, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/af;

    invoke-interface {p1, v0}, Landroid/support/v7/widget/ag;->h(Landroid/support/v7/widget/af;)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/widget/ag;->g(Landroid/support/v7/widget/af;)V
