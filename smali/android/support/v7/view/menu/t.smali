...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
    ...
    .line 127
    new-instance p3, Landroid/support/v7/widget/ax;
    ...
    invoke-direct {p3, p4, v0, p5, p6}, Landroid/support/v7/widget/ax;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ax;
...
.method private j()Z
    ...
    .line 165
    iget-object v3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ax;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ax;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ax;->e(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ax;->g(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ax;->h(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ax;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ax;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ax;->a(Landroid/widget/ListAdapter;)V
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/ax;->j()I
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/ax;->k()I
...
.method public b(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ax;->c(I)V
...
.method public c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ax;->d(I)V
