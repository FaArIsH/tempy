...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->a:Landroid/support/design/widget/d;
    ...
    invoke-virtual {v2, v3}, Landroid/support/design/widget/d;->a(Landroid/view/animation/Interpolator;)V
    ...
    .line 159
    iget-object p2, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->a:Landroid/support/design/widget/d;
    ...
    .line 159
    invoke-virtual {p2, p3}, Landroid/support/design/widget/d;->a(I)V
    ...
    .line 162
    invoke-virtual {p2, p3}, Landroid/support/design/widget/d;->b(I)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/design/widget/d;->d(I)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/design/widget/d;->c(I)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/view/s;->a(Landroid/view/View;Landroid/support/v4/view/o;)V

    return-void
.end method

.method static a(Landroid/view/View;)Landroid/support/design/widget/p;
    .locals 2
...
.method a(Landroid/support/v4/view/aa;)Landroid/support/v4/view/aa;
    ...
    .line 281
    :cond_1
    invoke-virtual {p1}, Landroid/support/v4/view/aa;->g()Landroid/support/v4/view/aa;
...
.method final b(Landroid/view/View;)I
    ...
    .line 1259
    invoke-static {p1}, Landroid/support/design/widget/CollapsingToolbarLayout;->a(Landroid/view/View;)Landroid/support/design/widget/p;
    ...
    .line 1262
    invoke-virtual {v0}, Landroid/support/design/widget/p;->c()I
...
.method protected drawableStateChanged()V
    ...
    invoke-virtual {v1, v0}, Landroid/support/design/widget/d;->a([I)Z
...
.method protected onAttachedToWindow()V
    ...
    invoke-static {v1}, Landroid/support/v4/view/s;->q(Landroid/view/View;)Z

    move-result v1

    invoke-static {p0, v1}, Landroid/support/v4/view/s;->b(Landroid/view/View;Z)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 428
    iget-object p1, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->d:Landroid/support/v4/view/aa;
    ...
    .line 437
    invoke-static {v3, p1}, Landroid/support/v4/view/s;->c(Landroid/view/View;I)V
    ...
    invoke-static {p0, v2, v3}, Landroid/support/v4/widget/r;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 458
    invoke-virtual {v2, v3, v4, v5, v6}, Landroid/support/design/widget/d;->b(IIII)V

    .line 469
    iget-object p1, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->a:Landroid/support/design/widget/d;
    ...
    invoke-virtual {p1, v2, v3, p4, p5}, Landroid/support/design/widget/d;->a(IIII)V

    .line 475
    iget-object p1, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->a:Landroid/support/design/widget/d;

    invoke-virtual {p1}, Landroid/support/design/widget/d;->i()V
    ...
    invoke-static {p2}, Landroid/support/design/widget/CollapsingToolbarLayout;->a(Landroid/view/View;)Landroid/support/design/widget/p;

    move-result-object p2

    invoke-virtual {p2}, Landroid/support/design/widget/p;->a()V
    ...
    invoke-virtual {p1, p2}, Landroid/support/design/widget/d;->a(Ljava/lang/CharSequence;)V
