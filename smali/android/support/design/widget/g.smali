...
# direct methods
.method constructor <init>(Landroid/support/design/widget/s;Landroid/support/design/widget/k;)V
    .locals 0

    .line 46
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/f;-><init>(Landroid/support/design/widget/s;Landroid/support/design/widget/k;)V
...
.method a(FF)V
    ...
    .line 92
    iget-object p1, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/s;

    invoke-virtual {p1}, Landroid/support/design/widget/s;->isFocused()Z
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/s;->isPressed()Z
    ...
    invoke-virtual {p1, v1}, Landroid/support/design/widget/s;->setTranslationZ(F)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/design/widget/s;->setTranslationZ(F)V
    ...
    invoke-virtual {p1, v1}, Landroid/support/design/widget/s;->setElevation(F)V
    ...
    .line 106
    iget-object v3, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/s;
    ...
    iget-object v4, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/s;
    ...
    .line 109
    sget-object v3, Landroid/support/design/widget/g;->a:Landroid/view/animation/Interpolator;
    ...
    .line 117
    sget-object p2, Landroid/support/design/widget/g;->a:Landroid/view/animation/Interpolator;

    invoke-virtual {v2, p2}, Landroid/animation/AnimatorSet;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    .line 118
    sget-object p2, Landroid/support/design/widget/g;->k:[I
    ...
    iget-object v6, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/s;

    .line 130
    invoke-virtual {v6}, Landroid/support/design/widget/s;->getTranslationZ()F
    ...
    .line 135
    sget-object p1, Landroid/support/design/widget/g;->a:Landroid/view/animation/Interpolator;

    invoke-virtual {p2, p1}, Landroid/animation/AnimatorSet;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    .line 136
    sget-object p1, Landroid/support/design/widget/g;->l:[I
    ...
    .line 140
    iget-object p2, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/s;
    ...
    .line 143
    sget-object p2, Landroid/support/design/widget/g;->m:[I
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/s;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

    .line 148
    :goto_1
    iget-object p1, p0, Landroid/support/design/widget/g;->o:Landroid/support/design/widget/k;

    invoke-interface {p1}, Landroid/support/design/widget/k;->b()Z
...
.method a(Landroid/graphics/Rect;)V
    ...
    iget v3, p0, Landroid/support/design/widget/g;->i:F

    add-float/2addr v2, v3

    .line 205
    invoke-static {v2, v0, v1}, Landroid/support/design/widget/j;->b(FFZ)F
    ...
    .line 207
    invoke-static {v2, v0, v1}, Landroid/support/design/widget/j;->a(FFZ)F
...
.method b(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/g;->p:Landroid/graphics/drawable/InsetDrawable;

    invoke-interface {p1, v0}, Landroid/support/design/widget/k;->a(Landroid/graphics/drawable/Drawable;)V
