...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 65
    iput v0, p0, Landroid/support/design/widget/d;->i:I
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->J:Landroid/text/TextPaint;
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->g:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->f:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->h:Landroid/graphics/RectF;
...
.method private c(F)V
    ...
    .line 369
    invoke-static {v2, v4, p1, v3}, Landroid/support/design/widget/d;->a(FFFLandroid/view/animation/Interpolator;)F

    move-result v2

    iget v4, p0, Landroid/support/design/widget/d;->S:F

    iget v5, p0, Landroid/support/design/widget/d;->O:F

    .line 370
    invoke-static {v4, v5, p1, v3}, Landroid/support/design/widget/d;->a(FFFLandroid/view/animation/Interpolator;)F
    ...
    .line 373
    iget-object p1, p0, Landroid/support/design/widget/d;->c:Landroid/view/View;
...
.method private e(F)V
    ...
    .line 535
    sget-boolean p1, Landroid/support/design/widget/d;->a:Z

    if-eqz p1, :cond_0

    iget p1, p0, Landroid/support/design/widget/d;->F:F
    ...
    :goto_0
    iput-boolean p1, p0, Landroid/support/design/widget/d;->A:Z

    .line 537
    iget-boolean p1, p0, Landroid/support/design/widget/d;->A:Z
...
.method private f(F)V
    ...
    invoke-static {p1, v2}, Landroid/support/design/widget/d;->a(FF)Z
    ...
    .line 560
    iget p1, p0, Landroid/support/design/widget/d;->l:F

    .line 561
    iput v3, p0, Landroid/support/design/widget/d;->F:F

    .line 562
    iget-object v1, p0, Landroid/support/design/widget/d;->w:Landroid/graphics/Typeface;

    iget-object v2, p0, Landroid/support/design/widget/d;->u:Landroid/graphics/Typeface;

    invoke-direct {p0, v1, v2}, Landroid/support/design/widget/d;->a(Landroid/graphics/Typeface;Landroid/graphics/Typeface;)Z
    ...
    .line 563
    iget-object v1, p0, Landroid/support/design/widget/d;->u:Landroid/graphics/Typeface;

    iput-object v1, p0, Landroid/support/design/widget/d;->w:Landroid/graphics/Typeface;
    ...
    iget-object v7, p0, Landroid/support/design/widget/d;->v:Landroid/graphics/Typeface;

    invoke-direct {p0, v6, v7}, Landroid/support/design/widget/d;->a(Landroid/graphics/Typeface;Landroid/graphics/Typeface;)Z
    ...
    iput-object v6, p0, Landroid/support/design/widget/d;->w:Landroid/graphics/Typeface;
    ...
    invoke-static {p1, v7}, Landroid/support/design/widget/d;->a(FF)Z
    ...
    iput p1, p0, Landroid/support/design/widget/d;->F:F
    ...
    .line 598
    iget p1, p0, Landroid/support/design/widget/d;->G:F
    ...
    .line 599
    :goto_5
    iput v2, p0, Landroid/support/design/widget/d;->G:F

    .line 600
    iput-boolean v5, p0, Landroid/support/design/widget/d;->I:Z

    .line 603
    :cond_8
    iget-object p1, p0, Landroid/support/design/widget/d;->y:Ljava/lang/CharSequence;
    ...
    .line 604
    :cond_9
    iget-object p1, p0, Landroid/support/design/widget/d;->J:Landroid/text/TextPaint;
    ...
    .line 610
    iget-object p1, p0, Landroid/support/design/widget/d;->x:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/d;->b(Ljava/lang/CharSequence;)Z

    move-result p1

    iput-boolean p1, p0, Landroid/support/design/widget/d;->z:Z
...
.method private o()V
    ...
    invoke-direct {p0, v1}, Landroid/support/design/widget/d;->f(F)V
    ...
    iget-object v4, p0, Landroid/support/design/widget/d;->y:Ljava/lang/CharSequence;

    iget-object v5, p0, Landroid/support/design/widget/d;->y:Ljava/lang/CharSequence;
    ...
    iget-boolean v5, p0, Landroid/support/design/widget/d;->z:Z
    ...
    .line 412
    iget-object v5, p0, Landroid/support/design/widget/d;->J:Landroid/text/TextPaint;

    invoke-virtual {v5}, Landroid/text/TextPaint;->descent()F

    move-result v5

    iget-object v9, p0, Landroid/support/design/widget/d;->J:Landroid/text/TextPaint;
    ...
    .line 414
    iget-object v9, p0, Landroid/support/design/widget/d;->g:Landroid/graphics/Rect;
    ...
    iput v9, p0, Landroid/support/design/widget/d;->p:F
    ...
    .line 422
    :cond_3
    iget-object v4, p0, Landroid/support/design/widget/d;->g:Landroid/graphics/Rect;
    ...
    iput v4, p0, Landroid/support/design/widget/d;->r:F
    ...
    .line 433
    :cond_5
    iget v1, p0, Landroid/support/design/widget/d;->i:I

    iget-boolean v3, p0, Landroid/support/design/widget/d;->z:Z
    ...
    iget-object v4, p0, Landroid/support/design/widget/d;->J:Landroid/text/TextPaint;
    ...
    .line 446
    iget-object v4, p0, Landroid/support/design/widget/d;->f:Landroid/graphics/Rect;
    ...
    iput v4, p0, Landroid/support/design/widget/d;->o:F
    ...
    iput v3, p0, Landroid/support/design/widget/d;->o:F
...
.method private p()V
    ...
    iget-object v8, p0, Landroid/support/design/widget/d;->J:Landroid/text/TextPaint;
...
.method public a(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v1, p0, Landroid/support/design/widget/d;->d:Z

    if-eqz v1, :cond_5

    .line 483
    iget v6, p0, Landroid/support/design/widget/d;->s:F

    .line 484
    iget v1, p0, Landroid/support/design/widget/d;->t:F
    ...
    iget-object v2, p0, Landroid/support/design/widget/d;->B:Landroid/graphics/Bitmap;
    ...
    iget v4, p0, Landroid/support/design/widget/d;->F:F

    mul-float v3, v3, v4

    .line 492
    iget v4, p0, Landroid/support/design/widget/d;->E:F
    ...
    iget-object v2, p0, Landroid/support/design/widget/d;->C:Landroid/graphics/Paint;
