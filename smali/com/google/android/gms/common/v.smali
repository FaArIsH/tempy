...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/v;->zzfrv:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/v;->zzfrw:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/v;->zzc(Landroid/content/Context;I)I
...
.method private static zza(Landroid/content/Context;ZII)I
    ...
    :goto_1
    invoke-static {v3}, Lcom/google/android/gms/common/internal/ag;->b(Z)V
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/w;->a(Landroid/content/Context;)Lcom/google/android/gms/common/w;

    invoke-static {v6, v2}, Lcom/google/android/gms/common/w;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v4, v2}, Lcom/google/android/gms/common/w;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    sget p1, Lcom/google/android/gms/common/v;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
...
.method public static zzbo(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/i;->b(Landroid/content/Context;I)I
...
.method public static zzc(Landroid/content/Context;I)I
    ...
    sget-object v0, Lcom/google/android/gms/common/v;->zzfrw:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/ac;->b(Landroid/content/Context;)I

    move-result v0

    if-eqz v0, :cond_1

    sget v1, Lcom/google/android/gms/common/v;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    invoke-static {p0, v0, v1, p1}, Lcom/google/android/gms/common/v;->zza(Landroid/content/Context;ZII)I
...
.method public static zzcf(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/v;->zzfrv:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static zzci(Landroid/content/Context;)Z
    ...
    sget-boolean v0, Lcom/google/android/gms/common/v;->zzfru:Z
    ...
    :try_start_0
    invoke-static {p0}, Lcom/google/android/gms/internal/j;->a(Landroid/content/Context;)Lcom/google/android/gms/internal/i;
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/gms/internal/i;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/common/w;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lcom/google/android/gms/common/w;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lcom/google/android/gms/common/v;->zzfrt:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lcom/google/android/gms/common/v;->zzfrt:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    sput-boolean v2, Lcom/google/android/gms/common/v;->zzfru:Z
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lcom/google/android/gms/common/v;->zzfrt:Z
...
.method public static zzd(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/v;->zzr(Landroid/content/Context;Ljava/lang/String;)Z
