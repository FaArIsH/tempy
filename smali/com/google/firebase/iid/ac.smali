.class public final Lcom/google/firebase/iid/ac;
.super Ljava/lang/Object;


# static fields
.field private static b:Lcom/google/firebase/iid/ac;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/ac;->c:Landroid/support/v4/g/m;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/ac;->d:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/ac;->a:Ljava/util/Queue;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/ac;->e:Ljava/util/Queue;
...
.method private final a(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/ac;->c:Landroid/support/v4/g/m;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/ac;->c:Landroid/support/v4/g/m;
    ...
    :cond_3
    :goto_0
    iget-object v2, p0, Lcom/google/firebase/iid/ac;->c:Landroid/support/v4/g/m;

    monitor-enter v2

    :try_start_1
    iget-object v3, p0, Lcom/google/firebase/iid/ac;->c:Landroid/support/v4/g/m;

    invoke-virtual {p2}, Landroid/content/Intent;->getAction()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4, v1}, Landroid/support/v4/g/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_5
    :try_start_2
    iget-object v1, p0, Lcom/google/firebase/iid/ac;->d:Ljava/lang/Boolean;
    ...
    :cond_a
    iget-object v0, p0, Lcom/google/firebase/iid/ac;->d:Ljava/lang/Boolean;
    ...
    invoke-static {p1, p2}, Landroid/support/v4/content/e;->a_(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public static declared-synchronized a()Lcom/google/firebase/iid/ac;
    .locals 2

    const-class v0, Lcom/google/firebase/iid/ac;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/ac;->b:Lcom/google/firebase/iid/ac;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/iid/ac;

    invoke-direct {v1}, Lcom/google/firebase/iid/ac;-><init>()V

    sput-object v1, Lcom/google/firebase/iid/ac;->b:Lcom/google/firebase/iid/ac;
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/ac;->e:Ljava/util/Queue;

    goto :goto_2

    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/ac;->a:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, p3}, Lcom/google/firebase/iid/ac;->a(Landroid/content/Context;Landroid/content/Intent;)I
