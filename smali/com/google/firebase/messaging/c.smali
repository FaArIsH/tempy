...
.method private final a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    iget-object p1, p0, Lcom/google/firebase/messaging/c;->d:Ljava/lang/reflect/Method;

    if-nez p1, :cond_6

    const-string p1, "setChannelId"

    invoke-static {p1}, Lcom/google/firebase/messaging/c;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/c;->d:Ljava/lang/reflect/Method;
...
.method static declared-synchronized a(Landroid/content/Context;)Lcom/google/firebase/messaging/c;
    ...
    sput-object v1, Lcom/google/firebase/messaging/c;->a:Lcom/google/firebase/messaging/c;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/c;->a:Lcom/google/firebase/messaging/c;
    :try_end_0
...
.method static b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/c;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method private final c(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/messaging/c;->e:Ljava/lang/reflect/Method;
    ...
    sget v9, Lcom/google/android/gms/a$b;->fcm_fallback_notification_channel_label:I
...
.method private final e(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    :cond_6
    iget-object p1, p0, Lcom/google/firebase/messaging/c;->b:Landroid/content/Context;

    iget-object v0, p0, Lcom/google/firebase/messaging/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, v6}, Lcom/google/firebase/messaging/c;->a(I)Z
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/c;->a(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/c;->a(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/c;->b(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/c;->b:Landroid/content/Context;
    ...
    invoke-static {v8, p1}, Lcom/google/firebase/messaging/c;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v3, v9, v8, v10}, Lcom/google/firebase/iid/ac;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/c;->b:Landroid/content/Context;

    iget-object v11, p0, Lcom/google/firebase/messaging/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v11}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v11

    invoke-static {v9, v11, v8, v10}, Lcom/google/firebase/iid/ac;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v3}, Lcom/google/firebase/messaging/c;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/c;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v11}, Lcom/google/firebase/messaging/c;->a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-direct {v3, v8}, Landroid/support/v4/app/ab$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v1}, Landroid/support/v4/app/ab$d;->b(Z)Landroid/support/v4/app/ab$d;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/ab$d;->a(I)Landroid/support/v4/app/ab$d;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/ab$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$d;
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/ab$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$d;

    new-instance v4, Landroid/support/v4/app/ab$c;

    invoke-direct {v4}, Landroid/support/v4/app/ab$c;-><init>()V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/ab$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$c;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v4/app/ab$d;->a(Landroid/support/v4/app/ab$g;)Landroid/support/v4/app/ab$d;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/ab$d;->e(I)Landroid/support/v4/app/ab$d;

    :cond_13
    if-eqz v0, :cond_14

    invoke-virtual {v3, v0}, Landroid/support/v4/app/ab$d;->a(Landroid/net/Uri;)Landroid/support/v4/app/ab$d;

    :cond_14
    if-eqz v9, :cond_15

    invoke-virtual {v3, v9}, Landroid/support/v4/app/ab$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ab$d;

    :cond_15
    if-eqz v10, :cond_16

    invoke-virtual {v3, v10}, Landroid/support/v4/app/ab$d;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/ab$d;
