...
# direct methods
.method private a(Lio/reactivex/u;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/c/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/reactivex/internal/operators/observable/ObservableRefCount$a;-><init>(Lio/reactivex/internal/operators/observable/ObservableRefCount;Lio/reactivex/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
...
.method public a(Lio/reactivex/u;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/operators/observable/ObservableRefCount;->a(Lio/reactivex/u;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/c/g;

    move-result-object p1

    invoke-virtual {v1, p1}, Lio/reactivex/d/a;->b(Lio/reactivex/c/g;)V
    :try_end_0
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/observable/ObservableRefCount;->a(Lio/reactivex/u;Lio/reactivex/disposables/a;)V
    :try_end_1
...
.method a(Lio/reactivex/u;Lio/reactivex/disposables/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2, v0}, Lio/reactivex/internal/operators/observable/ObservableRefCount$ConnectionObserver;-><init>(Lio/reactivex/internal/operators/observable/ObservableRefCount;Lio/reactivex/u;Lio/reactivex/disposables/a;Lio/reactivex/disposables/b;)V
    ...
    invoke-virtual {p1, v1}, Lio/reactivex/d/a;->subscribe(Lio/reactivex/u;)V
