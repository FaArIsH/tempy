...
.method private a(Landroid/support/v7/a/a$b;Z)Landroid/support/v7/internal/widget/k$c;
    .locals 4
    ...
    invoke-direct {v0, p0, v1, p1, p2}, Landroid/support/v7/internal/widget/k$c;-><init>(Landroid/support/v7/internal/widget/k;Landroid/content/Context;Landroid/support/v7/a/a$b;Z)V
...
.method static synthetic a(Landroid/support/v7/internal/widget/k;Landroid/support/v7/a/a$b;Z)Landroid/support/v7/internal/widget/k$c;
    .locals 1

    .prologue
    .line 57
    invoke-direct {p0, p1, p2}, Landroid/support/v7/internal/widget/k;->a(Landroid/support/v7/a/a$b;Z)Landroid/support/v7/internal/widget/k$c;
...
.method static synthetic a(Landroid/support/v7/internal/widget/k;)Landroid/support/v7/widget/j;
    .locals 1

    .prologue
    .line 57
    iget-object v0, p0, Landroid/support/v7/internal/widget/k;->e:Landroid/support/v7/widget/j;
...
.method private d()Landroid/widget/Spinner;
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/support/v7/widget/f;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, v2, v3}, Landroid/support/v7/widget/j$a;-><init>(II)V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 371
    invoke-virtual {p2}, Landroid/support/v7/internal/widget/k$c;->b()Landroid/support/v7/a/a$b;
...
.method public onMeasure(II)V
    ...
    .line 100
    iget-object v4, p0, Landroid/support/v7/internal/widget/k;->e:Landroid/support/v7/widget/j;

    invoke-virtual {v4}, Landroid/support/v7/widget/j;->getChildCount()I
    ...
    .line 119
    iget-object v1, p0, Landroid/support/v7/internal/widget/k;->e:Landroid/support/v7/widget/j;

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/j;->measure(II)V

    .line 120
    iget-object v1, p0, Landroid/support/v7/internal/widget/k;->e:Landroid/support/v7/widget/j;

    invoke-virtual {v1}, Landroid/support/v7/widget/j;->getMeasuredWidth()I
...
.method public setTabSelected(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/j;->getChildAt(I)Landroid/view/View;
