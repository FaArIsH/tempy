...
.field private final d:Landroid/support/v7/widget/j;
...
.method private a(I)V
    ...
    .line 368
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/k;
    ...
    .line 376
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/k;->f(I)V

    .line 377
    invoke-virtual {v3}, Landroid/support/v7/widget/k;->c()V

    .line 378
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/g/d;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/g/d;->a(Z)V

    .line 381
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/k;->m()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/k;
    .locals 2

    .prologue
    .line 505
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/k;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/k;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/k;->a(Landroid/widget/ListAdapter;)V

    .line 508
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/k;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/k;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/k;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/k;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 454
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/j;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/j;->layout(IIII)V
...
.method public setProvider(Landroid/support/v4/g/d;)V
    .locals 0

    .prologue
    .line 325
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/g/d;
